...
public class VeterinarianRestController {
    ...
    public ResponseEntity<Void> addAvailability(
        ...
        var location = uriBuilder
                .path("/vetclinic/api/veterinarians/{vetId}/availabilities/{availId}")
    ...
    @DeleteMapping("/{veterinarianId}/availabilities/{availabilityId}/exceptions/{exceptionId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteAvailabilityException(
        ...
        veterinarianService.deleteAvailabilityException(availabilityId, exceptionId);
    }
}